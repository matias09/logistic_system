...
PLATFORM_LINUX { platform_path = linux }

COMPILER_GCC  { compiler_path = gcc }
COMPILER_CLANG  { compiler_path = clang }

PROCESSOR_x64 { processor_path = x64 }
PROCESSOR_x86 { processor_path = x86 }
