...
% Strategic
  ...
  \node[strategic]  (node3) [below=of node2] {Gestion de Personal};
  \node[strategic]  (node4) [below=of node3] {Gestion de Finanzas};
...
% Operative
  ...
  \node[operative]  (node8) [below=of node7] {Pruebas de Integracion};

% Support
  \node[support]    (node9)  [below=of supp]  {Relevamiento de Informacion};
